	...
	<?php
		...
		if( $r1){
			while($row =mysqli_fetch_assoc($r1)){
				...
				echo'<h3 style="color:red"  >'.$user_name.'</h3>';
				echo '<p>'.$message.'</p>';
				echo'<hr >';
			}
		}
...
<?php
		...
		if (isset($_POST['submit'])){
			...
			$q='INSERT INTO`breads`(`id`, `user_name`, `message_text`,`date_time`) VALUES("","'.$_SESSION['user_name'].'","'.$message.'","'.$date.'")';
